    ...
    <div className="font-popins min-h-screen bg-base-100 text-base-content p-8 md:p-16">
      ...
      >
        ...
        <p className="text-lg md:text-xl text-neutral max-w-2xl mx-auto">
          Discover authentic local flavors, share your food journey, and connect
          with a community that celebrates the joy of eating.
        </p>
      </motion.section>
      ...
      >
        ...
        <p className="text-lg text-neutral">
          ...
          tradition, every bite has a story. Local Bite connects food lovers to
          these stories—right in their neighborhood.
        </p>
      </motion.section>
