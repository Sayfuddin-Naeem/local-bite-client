...
import { Award, Heart, MessageCircle, Star, TrendingUp, MapPin, LogOut } from 'lucide-react';
...
const mockUser = {
  ...
  achievements: [
    { id: 1, name: 'Food Explorer', icon: '🗺️', description: 'Reviewed 20+ restaurants' },
    { id: 2, name: 'Top Reviewer', icon: '⭐', description: 'Top 10% of reviewers' },
    { id: 3, name: 'Community Hero', icon: '💬', description: '50+ helpful comments' }
  ],
  recentActivity: [
    { id: 1, type: 'review', food: 'Chicken Biryani', restaurant: 'Star Kabab', date: '2 days ago', rating: 5 },
    { id: 2, type: 'favorite', food: 'Beef Burger', restaurant: 'Burger Lab', date: '5 days ago' },
    { id: 3, type: 'comment', food: 'Fuchka', restaurant: 'Street Corner', date: '1 week ago' }
  ]
};
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6 text-center transform hover:scale-105 transition-transform">
            ...
            <div className="text-sm font-inter text-neutral">
              Favorites
            </div>
          </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
                ...
                {mockUser.recentActivity.map((activity) => (
                  ...
                  >
                    <div className={`w-10 h-10 rounded-full flex items-center justify-center ${
                      ...
                      activity.type === 'favorite' ? 'bg-secondary/10 text-secondary' :
                    ...
                    <div className="flex-1">
                      <p className="font-semibold font-inter text-base-content mb-1" >
                        {activity.type === 'review' && `Reviewed ${activity.food}`}
                        {activity.type === 'favorite' && `Added ${activity.food} to favorites`}
                        {activity.type === 'comment' && `Commented on ${activity.food}`}
                      </p>
                      ...
                      <p className="text-xs text-[oklch(35%_0.02_60)] mt-1">{activity.date}</p>
                    </div>
                  </div>
                ))}
              </div>
          ...
          <div className="space-y-6">
            ...
            {/* Logout Button */}
            <button className="btn btn-error w-full rounded-2xl gap-2">
